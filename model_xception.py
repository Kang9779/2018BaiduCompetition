...
plt.savefig("xception-"+nowtime+".png")
...
resultsProp.to_csv("results"+nowtime+".csv",index=False,header=False)
...
submission.to_csv("xception_predict-"+nowtime+".csv",sep=" ",index=False,header=False)
...
print("=================模型文件保存中...====================")
model.save_weights("model_xception-"+nowtime+".h5")
